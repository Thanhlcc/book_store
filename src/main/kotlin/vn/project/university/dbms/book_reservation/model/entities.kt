...
import vn.project.university.dbms.book_reservation.controller.BookController
...
class BookCopy(
    ...
    @Column(columnDefinition = "CHAR(11) not null unique") val isbn: String
) {
...
class Reservation(
    ...
    val endTime: LocalDateTime = startTime.plusDays(7)
    @UpdateTimestamp
